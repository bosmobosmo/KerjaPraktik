                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                    <?php
                                    $result = mysqli_query($db, "SELECT * FROM bukubaru WHERE respond=FALSE ORDER BY dateReceived ASC;");
                                    while($row = mysqli_fetch_array($result))
                                        {
                                            ...
                                            echo "<td><form method='post' action='request_respond.php'> <button name='id' value=".$row['id']."> Done </button> </form>";
                                            echo "</tr>";
                                        }
                                    ?>
                                    </tbody>
