        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading --> 
                    <h1 class="h3 mb-2 text-gray-800">VRS</h1>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                    <?php
                                    $result = mysqli_query($db, "SELECT * FROM lss WHERE respond=FALSE ORDER BY dateReceived ASC;");
                                    while($row = mysqli_fetch_array($result))
                                        {
                                            ...
                                            echo "<td><form method='post' action='vrs_respond.php'> <button name='id' value=".$row['id']."> Done </button> </form>";
                                            echo "</tr>";
                                        }
                                    ?>
                                    </tbody>
